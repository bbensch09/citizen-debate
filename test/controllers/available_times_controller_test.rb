...
class AvailableTimesControllerTest < ActionController::TestCase
  ...
  test "should create available_time" do
    assert_difference('AvailableTime.count') do
      post :create, available_time: { debate_id: @available_time.debate_id, proposed_by: @available_time.proposed_by, proposed_time: @available_time.proposed_time, proposed_to: @available_time.proposed_to, status: @available_time.status }
    end
  ...
  test "should update available_time" do
    patch :update, id: @available_time, available_time: { debate_id: @available_time.debate_id, proposed_by: @available_time.proposed_by, proposed_time: @available_time.proposed_time, proposed_to: @available_time.proposed_to, status: @available_time.status }
    assert_redirected_to available_time_path(assigns(:available_time))
  end
